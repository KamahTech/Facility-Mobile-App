...
export default function NotificationsScreen() {
  ...
  const renderItem = React.useCallback(({ item }: { item: NotificationItem }) => {
    // Dynamic badges and icons depending on notification category
    let badgeBg = "";
    let iconName: "invoices" | "requestService" | "inviteVisitor" | "notification" = "notification";
    let iconColor = "";
    ...
    switch (item.type) {
      ...
      case "maintenance":
        ...
        iconName = "requestService";
        iconColor = "#D97706";
        break;
      case "visitor":
        badgeBg = "bg-purple-50 dark:bg-purple-950/40";
        iconName = "inviteVisitor";
        iconColor = "#7C3AED";
        break;
      case "announcement":
      default:
